                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    <a href="<?= base_url('produk'); ?>" type="button" class="btn btn-primary mb-3">
                                        Kembali
                                    </a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <p>
                                                Brosur : <a href="<?= base_url('upload/brosur/' . $produk->produk_brosur); ?>"><?= $produk->produk_nama ?></a>
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <img src="<?= base_url('upload/produk/' . $produk->produk_gambar); ?>" class="card-img-top">
                                        </div>
                                    </div>
                                </div>
                            </div>
