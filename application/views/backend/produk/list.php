                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    <a href="<?= base_url('produk/add'); ?>" type="button" class="btn btn-primary mb-3">
                                        Tambah
                                    </a>
                                        ...
                                        <tbody>
                                            <?php foreach ($produk as $row) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('produk/detail/' . $row->produk_id) ?>" class="btn btn-success">Detail</a>
                                                        <!-- <a href="<?= base_url('produk/edit/' . $row->produk_id) ?>" class="btn btn-warning">Edit</a> -->
                                                        <a href="<?= base_url('produk/delete/' . $row->produk_id) ?>" class="btn btn-danger">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
