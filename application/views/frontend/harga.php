			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a style="font-size: 15px;color:yellow ;font-weight: bolder;" href="<?= site_url('listHarga'); ?>">List Harga</a></li>
		...
		<div class="container">
			<div class="section-title text-center">
				...
				<div class="row text-center">
					<p class="mb-5">Harga sewaktu-waktu dapat berubah</p>
					<br>
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="service-widget">
							<div class="post-media_pp wow fadeIn">
								<img width="60%" class="text-center" src="<?= base_url('upload/harga/' . $harga->harga_gambar); ?>" alt="" class="img-responsive">
							</div>
